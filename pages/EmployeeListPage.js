exports.EmployeeListPage =
    class EmployeeListPage {
        constructor(page) {
            ...
            this.resultCheckboxWrapper = "(//div[contains(@class,'oxd-table-card')])[1]//span[contains(@class,'oxd-checkbox-input')]";
        ...
        async searchByEmployeeId(employeeId) {
            await this.page.locator(this.employeeIdSearchInput).pressSequentially(employeeId, { delay: 150 });
        ...
        async deleteFirstResult() {
            await this.page.locator(this.resultCheckboxWrapper).first().click();
